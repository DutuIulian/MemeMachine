...
public class MyTrustManager implements X509TrustManager {
    ...
    public MyTrustManager(Context context) throws KeyStoreException,
        ...
        ArrayList<X509Certificate> acceptedIssuersList = new ArrayList<>();
    ...
    private X509TrustManager getLocalManager(Context context)
        ...
        InputStream inputStream = new FileInputStream(new File(context.getFilesDir(),
                ConfigurationManager.CERTIFICATE_FILE_NAME));
